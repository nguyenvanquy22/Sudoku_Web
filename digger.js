class Digger {
    ...
    constructor(_level, _board, _boardSize) {
        ...
        this.holesCount = random(this.levels[this.LevelSelector][_level][1], this.levels[this.LevelSelector][_level][0])
    ...
    randomDig(howMany) {
        ...
        while (howMany > 0) {
            ...
            if (availabaleArray.length < 1) {
                ...
                let randomCell = availabaleArray[random(availabaleArray.length - 1)]
